...
/**
 * Server-side translator for non-component contexts (route handlers,
 * server-side data helpers) where React hooks — and therefore `next-intl`'s
 * `useTranslations` — aren't available.
 *
