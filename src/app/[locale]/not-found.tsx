...
/**
 * Locale-scoped 404, a pure RSC (`getTranslations` + `getLocale` from
 * `next-intl/server`). Rendered inside `app/[locale]/layout.tsx` so it
 * inherits the chrome (Header / Sidebar / Footer / Breadcrumbs) automatically.
 *
