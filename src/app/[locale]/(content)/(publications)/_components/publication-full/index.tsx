...
import type { GoodExampleResponse } from "@/app/[locale]/(content)/(publications)/(examples)/data";
import type { NewsItemResponse } from "@/app/[locale]/(content)/(publications)/nyheter/data";
...
import { type PublicationTeaserItem, Teaser } from "@/components/teaser";
    ...
    <Container>
      <article className="flex w-full flex-col gap-lg md:gap-xl">
        ...
        {publication.related && publication.related.length > 0 && (
          <GridList<PublicationTeaserItem>
